...
#add back ticks with 1976 as a start year and 2019 as the ending year - 4 is the interval
plt.xticks(range(1976, 2019, 4))

# add the 2 as an interval, also the number of movies never exceeds 10
